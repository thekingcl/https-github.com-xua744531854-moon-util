...
import com.moon.util.*;
import com.moon.util.Console.Level;
import com.moon.util.console.ConsoleControl.Classify;
import com.moon.util.json.JSON;
import com.moon.util.json.JSONArray;
import com.moon.util.json.JSONObject;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

import static com.moon.lang.ClassUtil.forName;
import static com.moon.lang.ClassUtil.requireExtendsOf;
import static com.moon.lang.ThrowUtil.noInstanceError;
import static com.moon.lang.annotation.AnnotatedUtil.get;
import static com.moon.util.FilterUtil.nullableLast;
import static com.moon.util.OptionalUtil.computeOrElse;
import static com.moon.util.OptionalUtil.orElseGet;
...
final class ConsoleSettingsUtil {
    ...
    public static final ConsoleSettings parseByStackTraces(StackTraceElement[] traces, Class topClass) {
        ...
        for (int i = 0; i < traces.length; i++) {
            if ((clazz = forName((element = traces[i]).getClassName())) == Console.class
                ...
                return ConsoleGlobal.CONSOLE.getSettings();
            }
        ...
        return computeOrElse(controls, ConsoleSettingsUtil::mergeSettings, ConsoleGlobal.CONSOLE.getSettings());
    }
    ...
    private static final ConsoleSettings parseConsoleControl(ConsoleControl control) {
        return orElseGet(parseByClassOrJSON(control), () -> new ConsoleSettings(control));
    }

    private static final ConsoleSettings parseByClassOrJSON(ConsoleControl consoleControl) {
        return orElseGet(parseByClass(consoleControl),
