...
import static com.moon.lang.EnumUtil.last;
 ...
 * <p>
 * 关于{@link ConsoleGlobal}：通过系统启动参数设置基础路径
 * 1、全局输出基数路径通过系统启动参数（moonBasePath）设置，设置方法为私有方法，原则上不允许修改
 * 2、可手动更改默认全局 settings，默认为{@link ConsoleSettings#DEFAULT}
 *
 * @author benshaoye
 */
public interface Console extends Printable, Timing {
     ...
     * 全局控制
     */
    ConsoleGlobal GLOBAL = ConsoleGlobal.CONSOLE;
    /**
     * 全局默认输出
     */
    Console out = of();
