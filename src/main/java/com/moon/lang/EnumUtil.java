...
public final class EnumUtil {
     ...
     * @return
     */
    public static <T extends Enum<T>> EnumSet<T> valuesSet(Class<T> enumType) {
     ...
     * @return
     */
    public static <T extends Enum<T>> int length(Class<T> enumType) {
        return values(enumType).length;
    }
    ...
    public static <T extends Enum<T>> T valueAt(Class<T> enumType, int index) {
        return toEnum(enumType, index);
    }
    ...
    public static <T extends Enum<T>> T toEnum(Class<T> enumType, int ordinal) {
        try {
            ...
            throw new IllegalArgumentException(
                "No enum constant " + enumType.getCanonicalName() + "<ENUMS>[" + ordinal + "]");
        }
    }
    ...
    public static <T extends Enum<T>> T toEnum(Object value, Class<T> enumType) {
        ...
        throw new IllegalArgumentException(
            "No enum constant " + enumType.getCanonicalName() + "." + value);
    }
}
